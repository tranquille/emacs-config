...
These are settings that do not depends on packages and are build-in enhancements to the UI.
** Look & Feel
...
#+BEGIN_SRC emacs-lisp
  (use-package prettier-js
    :ensure t
    :config
    (setq prettier-js-command "./node_modules/.bin/prettier")
